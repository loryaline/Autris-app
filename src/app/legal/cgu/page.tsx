  ...
  return (
    <>
      ...
      <p>
        ...
        francophones, édité par Chênerêve Éditions (Suisse). Il permet de
        rédiger, organiser et exporter des manuscrits, des fiches de
        worldbuilding, des plannings narratifs et des notes.
      </p>
